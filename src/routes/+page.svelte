...
<svelte:head>
	<title>株式会社Lanespire - コードで、ビジネスの未来を実装する</title>
	<meta
		name="description"
		content="株式会社Lanespireは、Web制作からAI導入支援まで、最新技術でお客様のビジネスに革新をもたらすWeb開発会社です。"
	/>
	<meta
		name="keywords"
		content="Web制作, AI導入支援, 業務自動化, n8n, NoCode, LowCode, モバイルアプリ開発, 受託開発, 東京, 銀座"
	/>
	<meta name="author" content="株式会社Lanespire" />
