...
with sync_playwright() as p:
    ...
    for width in (320, 390, 768, 920, 1024, 1440, 1920):
        ...
        check(f'{width} fixed package display', page.locator('.calc-plan-fixed strong').inner_text() == '¥98,000')
        page.locator('#custom-input').fill('35')
        check(f'{width} custom total update', page.locator('#template-total').inner_text() == '¥548,000')
