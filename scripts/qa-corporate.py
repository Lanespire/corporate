...
with sync_playwright() as p:
    ...
    check('commissioned cases first', page.locator('.work-card h3').all_text_contents()[:2]==['日程調整システム','営業CRM'])
    check('two commissioned and five owned labels', page.locator('.work-card .commissioned').count()==2 and page.locator('.work-card .owned').count()==5)
    ...
    check('commissioned detail dialog opens', page.locator('#project-dialog').evaluate('(e)=>e.open'))
